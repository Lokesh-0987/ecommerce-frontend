...
function Testimonials() {
	const testimonials = [
      ...
      Vivamus et nisi non elit finibus faucibus.`,
		...
		{
			name: "John Smith",
			image: "/images/johnsmith-768.webp",
      ...
      Iusto repellendus sit temporibus?`,
		...
		{
			name: "Ayesha Khan",
			image: "/images/ayeshakhan-768.webp",
				...
				{testimonials.map((t, index) => (
					<div className="col-12 col-md-6 col-lg-4" key={index}>
						<div className="card h-100 shadow text-center p-3">
							<img
								src={`/images/products/${item.id}-768.webp`}
								srcSet={`
    /images/products/${item.id}-480.webp 480w,
    /images/products/${item.id}-768.webp 768w,
    /images/products/${item.id}-1200.webp 1200w
  `}
								alt={t.name}

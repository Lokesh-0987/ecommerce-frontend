					...
					{filteredProducts.map((product) => (
						<div key={product.id} className="col-12 col-sm-6 col-md-4 mb-4">
							<div
								...
								<img
									src={`/images/products/${product.image}-768.webp`}
									srcSet={`
    /images/products/${product.image}-480.webp 480w,
    /images/products/${product.image}-768.webp 768w,
    /images/products/${product.image}-1200.webp 1200w
  `}

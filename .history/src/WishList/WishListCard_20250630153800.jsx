					...
					return (
						<div key={product.id} className="col-12 col-sm-6 col-md-3 mb-4">
							<div className="card h-100 shadow-sm">
								<img
									src={`/images/products/${product.id}-768.webp`}
									srcSet={`
    /images/products/${product.id}-480.webp 480w,
    /images/products/${product.id}-768.webp 768w,
    /images/products/${product.id}-1200.webp 1200w
  `}

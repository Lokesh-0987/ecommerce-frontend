...
function Header() {
	...
	return (
		<header id="header" className="header bg-light shadow-sm p-0">
					...
					{currentUser ? (
						<div className="position-relative ms-2">
							<div
								...
								className="bg-primary text-white rounded-circle d-flex align-items-center justify-content-center m-2 header__profile"
								style={{
									width: "40px",
									height: "40px",
									cursor: "pointer",
						...
						<button
							className="btn btn-outline-primary btn-sm ms-2 m-3 p-2"
